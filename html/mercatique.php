...
<head>
    ...
    <title>Bulot Montagnard : mercatique</title>
    <link rel="shortcut icon" href="../img/bulot-montagnard-favicon.ico">
    <meta name="description" content="Fondé en 1992 par Tonio Vaucellio, Bulot montagnard est le numéro un des boissons bulot. Bulot, la boisson qui accompagnera vos longues randonnées à la montagne." />
</head>
...
<body>
	<div class="body2">
        ...
        <div class="contenu">
			...
			<center><img alt="boisson bulot de couleur noir" src="../img/bulot-noir.jpg"></center
