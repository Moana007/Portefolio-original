...
<body>
	<div class="body2">
        ...
        <!-- Contenu -->		
        <div class="contenu">
			<h1>Les moyens de communications mis en place par Bulot Montagnard</h2> 
			<h2>1) Moyen de communication de Bulot Montagnard </h2>
			<p>
				Maintenant intéressons nous aux outils que la société dont elle a recours, commençons par les divers sponsorings, dont ceux qui sont en montagne. D’abord nous évoquerons des sponsors du domaine du sport.
			</p> 
			<p>
			...
			<center><img alt="logo de Bulot Montagnard" src="../img/bulot-orange.jpg"></center>
